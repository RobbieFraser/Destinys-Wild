...
public abstract class Packet {
	...
	/**
	 * A representation of all the different packet types as enums and the int
	 * that represents them
	 */
	public static enum PacketTypes {
		INVALID(-1), LOGIN(00), DISCONNECT(01), MOVE(02), REMOVEITEM(03), TIME(
				04), TORCH(05), ENEMY(06), HEALTH(07);
	 ...
	 * 
	 * @param packetID
	 *            -> the ID that you want to find the packet type of
	 ...
	 * 
	 * @param data
	 *            -> data that you want to convert to a string and read
	...
	/**
	 * Returns the relevant packet type based off the ID An alternative method
	 * when an int is used as the identifier
	 * 
	 * @param id
	 *            -> the ID that you want to find the packet type of
	 * @return -> the type of packet it is
